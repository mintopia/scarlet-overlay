...
/**
 * Reseed the canonical catalog so the derived power keys (house_battery_power,
 * ecoflow_net_watts) reach already-migrated environments. Idempotent: applyBaseline
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        app(CanonicalCatalog::class)->applyBaseline(
            ...
            'reset',
            'migration',
            'Reseed: derived power canonical keys (house_battery_power, ecoflow_net_watts)',
        );
    }
