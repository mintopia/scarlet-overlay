    ...
    <div class="admin-shell">
        ...
        >
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/overlay/map" target="_blank" class="nav-external">
                    Overlay (Map) <span class="nav-arrow">↗</span>
                </a>
...
const breadcrumbMap = {
    ...
    'Admin/Dash/Main': [home, { label: 'Main' }],
    'Admin/Dash/Tech': [home, { label: 'Tech' }],
    'Admin/Dash/Ops': [home, { label: 'Ops' }],
    'Admin/Dash/Skipper': [home, { label: 'Skipper' }],
