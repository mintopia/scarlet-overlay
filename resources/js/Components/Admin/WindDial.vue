...
<template>
    <svg :width="size" :height="size" viewBox="0 0 190 190">
        ...
        <!-- Point of sail zones -->
        <path d="M95,95 L82,10 A85,85 0 0,1 108,10 Z" fill="oklch(0.48 0.22 25 / 0.14)"/>
        <path d="M95,95 L108,10 A85,85 0 0,1 140,22 Z" fill="oklch(0.42 0.14 178 / 0.12)"/>
        <path d="M95,95 L82,10 A85,85 0 0,0 50,22 Z" fill="oklch(0.42 0.14 178 / 0.12)"/>
        <path d="M95,95 L140,22 A85,85 0 0,1 168,52 Z" fill="oklch(0.42 0.14 178 / 0.08)"/>
        <path d="M95,95 L50,22 A85,85 0 0,0 22,52 Z" fill="oklch(0.42 0.14 178 / 0.08)"/>
        <path d="M95,95 L168,52 A85,85 0 0,1 178,82 Z" fill="oklch(0.48 0.17 70 / 0.1)"/>
        <path d="M95,95 L22,52 A85,85 0 0,0 12,82 Z" fill="oklch(0.48 0.17 70 / 0.1)"/>
        <path d="M95,95 L178,82 A85,85 0 0,1 160,160 Z" fill="oklch(0.48 0.17 70 / 0.14)"/>
        <path d="M95,95 L12,82 A85,85 0 0,0 30,160 Z" fill="oklch(0.48 0.17 70 / 0.14)"/>
        <path d="M95,95 L160,160 A85,85 0 0,1 95,180 Z" fill="oklch(0.45 0.12 90 / 0.1)"/>
        <path d="M95,95 L30,160 A85,85 0 0,0 95,180 Z" fill="oklch(0.45 0.12 90 / 0.1)"/>
