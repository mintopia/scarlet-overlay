<template>
    <AdminLayout>
        ...
        <div v-if="showReloadModal" style="position: fixed; inset: 0; z-index: 100; display: flex; align-items: center; justify-content: center;">
            ...
            <div style="position: relative; background: var(--color-surface); border-radius: 12px; padding: 28px 32px; max-width: 420px; width: 100%; margin: 0 16px; box-shadow: 0 20px 60px rgba(0,0,0,0.25); color: var(--color-text-primary);">
