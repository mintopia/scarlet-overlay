...
return [
    ...
    'metrics' => [
        ...
        'mappings' => [
            ...
            'history' => [
                'track_latitude' => 'max(scarlet_gps_latitude_deg)',
                'track_longitude' => 'max(scarlet_gps_longitude_deg)',
                ...
                'temp_forepeak' => 'max(scarlet_mqtt_temperature{topic="zigbee2mqtt/Forepeak cabin"})',
                'temp_quarterberth' => 'max(scarlet_mqtt_temperature{topic="zigbee2mqtt/Quarterberth"})',
                'temp_main_cabin' => 'max(scarlet_mqtt_temperature{topic="zigbee2mqtt/Main Cabin"})',
                'humidity_forepeak' => 'max(scarlet_mqtt_humidity{topic="zigbee2mqtt/Forepeak cabin"})',
                'humidity_quarterberth' => 'max(scarlet_mqtt_humidity{topic="zigbee2mqtt/Quarterberth"})',
                'humidity_main_cabin' => 'max(scarlet_mqtt_humidity{topic="zigbee2mqtt/Main Cabin"})',
                'pressure_forepeak' => 'max(scarlet_mqtt_pressure{topic="zigbee2mqtt/Forepeak cabin"})',
                ...
                'water_level' => 'max(scarlet_mqtt_percent{topic="watertank"})',
            ...
            'explore' => [
                ...
                'temp_forepeak' => [
                    ...
                    'query' => 'scarlet_mqtt_temperature{topic="zigbee2mqtt/Forepeak cabin"}',
                    'group' => 'cabin',
                ],
                'temp_quarterberth' => [
                ...
                'humidity_forepeak' => [
                    ...
                    'unit' => '%',
                    'color' => 'oklch(0.70 0.14 70)',
                    'query' => 'scarlet_mqtt_humidity{topic="zigbee2mqtt/Forepeak cabin"}',
                    'group' => 'cabin',
                ],
            ...
            'log' => [
                'latitude' => 'max(scarlet_gps_latitude_deg)',
                'longitude' => 'max(scarlet_gps_longitude_deg)',
                'signalk_latitude' => 'max(scarlet_signalk_navigation_position_latitude)',
                'signalk_longitude' => 'max(scarlet_signalk_navigation_position_longitude)',
                ...
                'awa' => 'max(scarlet_signalk_environment_wind_angleApparent)',
                'stw' => 'max(scarlet_signalk_navigation_speedThroughWater)',
                'heading' => 'max(scarlet_signalk_navigation_headingTrue)',
                'cog' => 'max(scarlet_signalk_navigation_courseOverGroundTrue)',
                'pressure' => 'max(scarlet_mqtt_pressure{topic="zigbee2mqtt/Forepeak cabin"})',
