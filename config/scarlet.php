...
return [
    ...
    'metrics' => [
        ...
        'mappings' => [
            ...
            'history' => [
                'track_latitude' => 'max(scarlet_gps_latitude_deg{gps_source="signalk"} != 0) default max(scarlet_gps_latitude_deg{gps_source="onboard"} != 0)',
                'track_longitude' => 'max(scarlet_gps_longitude_deg{gps_source="signalk"} != 0) default max(scarlet_gps_longitude_deg{gps_source="onboard"} != 0)',
            ...
            'log' => [
                ...
                'stw' => 'max(keep_last_value(scarlet_signalk_navigation_speedThroughWater))',
                'heading' => 'max(keep_last_value(scarlet_signalk_navigation_headingTrue))',
                'cog' => 'max(keep_last_value(scarlet_signalk_navigation_courseOverGroundTrue))',
                'pressure' => 'max(keep_last_value(scarlet_mqtt_pressure{topic="zigbee2mqtt/Forepeak cabin"}))',
                'wp_distance' => 'max(keep_last_value(scarlet_signalk_navigation_courseGreatCircle_nextPoint_distance)) / 1852',
                'wp_ttg' => 'max(keep_last_value(scarlet_signalk_navigation_courseGreatCircle_nextPoint_timeToGo))',
                'battery_soc' => 'max(keep_last_value(scarlet_signalk_electrical_batteries_0_capacity_stateOfCharge)) * 100',
                'water_level' => 'max(keep_last_value(scarlet_mqtt_percent{topic="watertank"}))',
                'fuel_level' => 'max(keep_last_value(scarlet_signalk_tanks_fuel_currentLevel)) * 100',
            ],
        ],
    ],
];
