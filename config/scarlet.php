...
return [
    ...
    'metrics' => [
        ...
        'mappings' => [
            ...
            'gps' => [
                'latitude' => 'max(scarlet_signalk_navigation_position_latitude != 0) default max(scarlet_gps_latitude_deg != 0)',
                'longitude' => 'max(scarlet_signalk_navigation_position_longitude != 0) default max(scarlet_gps_longitude_deg != 0)',
            ...
            'history' => [
                'track_latitude' => 'max(scarlet_signalk_navigation_position_latitude != 0) default max(scarlet_gps_latitude_deg != 0)',
                'track_longitude' => 'max(scarlet_signalk_navigation_position_longitude != 0) default max(scarlet_gps_longitude_deg != 0)',
