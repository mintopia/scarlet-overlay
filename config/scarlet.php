    ...
    'metrics' => [
        ...
        'mappings' => [
            ...
            'history' => [
                ...
                'temp_forepeak' => 'max(last_over_time(scarlet_mqtt_temperature{topic="zigbee2mqtt/Forepeak cabin"}[2h]))',
                'temp_quarterberth' => 'max(last_over_time(scarlet_mqtt_temperature{topic="zigbee2mqtt/Quarterberth"}[2h]))',
                'temp_main_cabin' => 'max(last_over_time(scarlet_mqtt_temperature{topic="zigbee2mqtt/Main Cabin"}[2h]))',
                'humidity_forepeak' => 'max(last_over_time(scarlet_mqtt_humidity{topic="zigbee2mqtt/Forepeak cabin"}[2h]))',
                'humidity_quarterberth' => 'max(last_over_time(scarlet_mqtt_humidity{topic="zigbee2mqtt/Quarterberth"}[2h]))',
                'humidity_main_cabin' => 'max(last_over_time(scarlet_mqtt_humidity{topic="zigbee2mqtt/Main Cabin"}[2h]))',
                'pressure_forepeak' => 'max(last_over_time(scarlet_mqtt_pressure{topic="zigbee2mqtt/Forepeak cabin"}[2h]))',
                ...
                'water_level' => 'max(last_over_time(scarlet_mqtt_percent{topic="watertank"}[2h]))',
            ...
            'explore' => [
                ...
                'temp_main_cabin' => [
                    ...
                    'query' => 'last_over_time(scarlet_mqtt_temperature{topic="zigbee2mqtt/Main Cabin"}[2h])',
                    'group' => 'cabin',
                    'type' => 'standard',
                ...
                'temp_forepeak' => [
                    ...
                    'query' => 'last_over_time(scarlet_mqtt_temperature{topic="zigbee2mqtt/Forepeak cabin"}[2h])',
                    'group' => 'cabin',
                    'type' => 'standard',
                ...
                'temp_quarterberth' => [
                    ...
                    'unit' => '°C',
                    'color' => 'oklch(0.60 0.16 240)',
                    'query' => 'last_over_time(scarlet_mqtt_temperature{topic="zigbee2mqtt/Quarterberth"}[2h])',
                    'group' => 'cabin',
                    'type' => 'standard',
                ...
                'humidity_forepeak' => [
                    ...
                    'unit' => '%',
                    'color' => 'oklch(0.70 0.14 70)',
                    'query' => 'last_over_time(scarlet_mqtt_humidity{topic="zigbee2mqtt/Forepeak cabin"}[2h])',
                    'group' => 'cabin',
                    'type' => 'gauge',
                ...
                'humidity_quarterberth' => [
                    ...
                    'unit' => '%',
                    'color' => 'oklch(0.60 0.16 240)',
                    'query' => 'last_over_time(scarlet_mqtt_humidity{topic="zigbee2mqtt/Quarterberth"}[2h])',
                    'group' => 'cabin',
                    'type' => 'gauge',
                ],
                'humidity_main_cabin' => [
                    ...
                    'unit' => '%',
                    'color' => 'oklch(0.65 0.18 330)',
                    'query' => 'last_over_time(scarlet_mqtt_humidity{topic="zigbee2mqtt/Main Cabin"}[2h])',
                    'group' => 'cabin',
                    'type' => 'gauge',
                ],
                'pressure_forepeak' => [
                    ...
                    'unit' => 'hPa',
                    'color' => 'oklch(0.55 0.15 240)',
                    'query' => 'last_over_time(scarlet_mqtt_pressure{topic="zigbee2mqtt/Forepeak cabin"}[2h])',
                    'group' => 'cabin',
                    'type' => 'standard',
                ],
                ...
                'water_level' => [
                    ...
                    'unit' => '%',
                    'color' => 'oklch(0.42 0.14 245)',
                    'query' => 'last_over_time(scarlet_mqtt_percent{topic="watertank"}[2h])',
                    'group' => 'tanks',
                    'type' => 'gauge',
                    'dashboard_indicator' => 'level_bar',
                    'related' => ['fuel_level'],
            ...
            'log' => [
                ...
                'pressure' => 'max(last_over_time(scarlet_mqtt_pressure{topic="zigbee2mqtt/Forepeak cabin"}[2h]))',
